        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UploadUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UploadAuthor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UploadFile = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
